...
int main(int argc, char** argv[]) 
{
    ...
    double encTime = static_cast<double>(encendtime - encstarttime) / CLOCKS_PER_SEC;
    double decTime = static_cast<double>(decendtime - decstarttime) / CLOCKS_PER_SEC;

    wcout << L"Encrypt time: " << encTime << L" seconds" << endl;
    wcout << L"Decrypt time: " << decTime << L" seconds" << endl;
